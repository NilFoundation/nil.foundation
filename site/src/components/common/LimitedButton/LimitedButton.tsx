...
export const LimitedButton = ({children, className, primary, arrow, href, icon}: LimitedButtonProps) => {
    return <a className={cn(s.button, primary ? s.button_primary : null, className)} href={href ||''}>
        ...
        {icon ? icon : (arrow &&
            <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={s.arrow}>
                <rect x="13.1055" y="25.5364" width="17.7246" height="2.29197" transform="rotate(-45 13.1055 25.5364)" />
